...
public class RMAppImpl implements RMApp, Recoverable {
  ...
  public RMAppImpl(ApplicationId applicationId, RMContext rmContext,
    ...
    LOG.info("{intellij} RMAppState.NEW " + this.applicationId.toString());
  ...
  public void handle(RMAppEvent event) {
    ...
    try {
      ...
      try {
        ...
        LOG.info("{intellij} start transfer state in state_machine : " + event.getType());
  ...
  private void createNewAttempt() {
    ...
    LOG.info("{intellij} " + appAttemptId + "put into attempts");
  ...
  private static final class AddApplicationToSchedulerTransition extends
    ...
    @Override
    public void transition(RMAppImpl app, RMAppEvent event) {
      LOG.info("{intellij} " + app.applicationId + "from RMAppState.NEW_SAVING to RMAppState.SUBMITTED");
  ...
  private static final class StartAppAttemptTransition extends RMAppTransition {
    @Override
    public void transition(RMAppImpl app, RMAppEvent event) {
      LOG.info("{intellij} " + app.getApplicationId() + "from RMAppState.SUBMITTED to RMAppState.ACCEPTED");
  ...
  private static final class RMAppNewlySavingTransition extends RMAppTransition {
    ...
    public void transition(RMAppImpl app, RMAppEvent event) {
      ...
      LOG.info("{intellij} " + app.applicationId + "from RMAppState.NEW to RMAppState.NEW_SAVING");
