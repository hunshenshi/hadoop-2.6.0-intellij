...
public class FairScheduler extends
  ...
  protected synchronized void addApplication(ApplicationId applicationId,
    ...
    LOG.info("{intellij} check assign queue");
    ...
    LOG.info("{intellij} create FSAppAttempt for scheduler");
    SchedulerApplication<FSAppAttempt> application =
        new SchedulerApplication<FSAppAttempt>(queue, user);
    LOG.info("{intellij} put appAttempt into applications[map],then app submit sucess");
    ...
    if (isAppRecovering) {
      ...
      LOG.info("{intellij} " + applicationId + "submit sucess, active RMAppEvent by RMAppEventType.APP_ACCEPTED ");
      rmContext.getDispatcher().getEventHandler()
  ...
  public void handle(SchedulerEvent event) {
    ...
    case APP_ADDED:
      ...
      LOG.info("{intellij} " + appAddedEvent.getApplicationId() + "add in scheduler");
