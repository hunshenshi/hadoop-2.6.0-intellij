...
public class ContainerImpl implements Container {
  ...
  // private to public by szw
  public final NodeManagerMetrics metrics;
  ...
  // private to public by szw
  public final Map<LocalResourceRequest,List<String>> pendingResources =
    new HashMap<LocalResourceRequest,List<String>>();
  private final Map<Path,List<String>> localizedResources =
    new HashMap<Path,List<String>>();
  public final List<LocalResourceRequest> publicRsrcs =
    new ArrayList<LocalResourceRequest>();
  public final List<LocalResourceRequest> privateRsrcs =
    new ArrayList<LocalResourceRequest>();
  public final List<LocalResourceRequest> appRsrcs =
    new ArrayList<LocalResourceRequest>();
